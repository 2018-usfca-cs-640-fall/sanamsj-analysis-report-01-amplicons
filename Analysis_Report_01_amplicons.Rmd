...
```{r-histogram of examining diversity of phyla acroos sample set in both gender}
...
**Figure3** Diversity of differenet phyla in both gender colored by class.
