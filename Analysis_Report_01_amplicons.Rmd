in---
title: "Analysis Report 1: Compare different bacterial taxa on male vs female hands
...
**Figure4**: Histogram that represents the diversity of bacteria in females samples.
...
```{r histogram-showing-the-abundance-of-different-of-bacteria-in-males-samples}
male_phyloseq_obj <- subset_samples(phyloseq_obj, Sex == "male")
plot_bar(male_phyloseq_obj, x = "Class")
```
       
**Figure 5**: Histogram that represents the diversity of bacteria in males samples.
